 ...
 */
@Component
public class PlaceOrderActivity implements JavaDelegate {
	private static final Logger LOG = LoggerFactory.getLogger(PlaceOrderActivity.class);

	public static final String SERVICE_ACTION = "initiate";
